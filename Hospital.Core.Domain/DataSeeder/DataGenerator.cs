...
public static class DataSeeder
{
    ...
    public static Patient[] SeedPatients() => new[]
    {
        ...
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000002"), PassportNumber = "2222 000002", Name = "Светлана", Surname = "Павлова", Patronymic = "Сергеевна", BirthDate = new DateOnly(1987, 4, 14), Address = "Мира 7", Gender = Gender.Female, BloodType = BloodType.A, RhesusFactor = RhesusFactor.Negative, PhoneNumber = "+79002222222" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000003"), PassportNumber = "2222 000003", Name = "Никита", Surname = "Сергеев", Patronymic = "Павлович", BirthDate = new DateOnly(2000, 12, 1), Address = "Гагарина 10", Gender = Gender.Male, BloodType = BloodType.B, RhesusFactor = RhesusFactor.Positive, PhoneNumber = "+79003333333" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000004"), PassportNumber = "2222 000004", Name = "Марина", Surname = "Соколова", Patronymic = "Олеговна", BirthDate = new DateOnly(1999, 3, 3), Address = "Советская 15", Gender = Gender.Female, BloodType = BloodType.AB, RhesusFactor = RhesusFactor.Positive, PhoneNumber = "+79004444444" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000005"), PassportNumber = "2222 000005", Name = "Павел", Surname = "Михайлов", Patronymic = "Андреевич", BirthDate = new DateOnly(1985, 10, 20), Address = "Парковая 18", Gender = Gender.Male, BloodType = BloodType.O, RhesusFactor = RhesusFactor.Negative, PhoneNumber = "+79005555555" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000006"), PassportNumber = "2222 000006", Name = "Екатерина", Surname = "Новикова", Patronymic = "Михайловна", BirthDate = new DateOnly(1993, 5, 15), Address = "Центральная 9", Gender = Gender.Female, BloodType = BloodType.B, RhesusFactor = RhesusFactor.Positive, PhoneNumber = "+79006666666" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000007"), PassportNumber = "2222 000007", Name = "Игорь", Surname = "Васильев", Patronymic = "Дмитриевич", BirthDate = new DateOnly(1990, 11, 8), Address = "Школьная 22", Gender = Gender.Male, BloodType = BloodType.A, RhesusFactor = RhesusFactor.Positive, PhoneNumber = "+79007777777" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000008"), PassportNumber = "2222 000008", Name = "Алина", Surname = "Григорьева", Patronymic = "Станиславовна", BirthDate = new DateOnly(1998, 1, 30), Address = "Молодежная 3", Gender = Gender.Female, BloodType = BloodType.O, RhesusFactor = RhesusFactor.Negative, PhoneNumber = "+79008888888" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000009"), PassportNumber = "2222 000009", Name = "Руслан", Surname = "Александров", Patronymic = "Владимирович", BirthDate = new DateOnly(1982, 7, 19), Address = "Заречная 12", Gender = Gender.Male, BloodType = BloodType.AB, RhesusFactor = RhesusFactor.Negative, PhoneNumber = "+79009999999" },
        new Patient { Id = Guid.Parse("d0000000-0000-0000-0000-000000000000"), PassportNumber = "2222 000010", Name = "Юлия", Surname = "Тарасова", Patronymic = "Егоровна", BirthDate = new DateOnly(1992, 9, 25), Address = "Пушкина 5", Gender = Gender.Female, BloodType = BloodType.B, RhesusFactor = RhesusFactor.Positive, PhoneNumber = "+79000000000" },
    };
